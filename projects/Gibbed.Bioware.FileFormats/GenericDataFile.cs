...
{
    public class GenericDataFile : GenericFile
    {
        ...
        private object ExportGeneric(ExportState state)
        {
            ...
            var input = this.Data;
            var type = input.ReadValueU16(endian);
            var flags = (GFF.FieldFlags)input.ReadValueU16(endian);
