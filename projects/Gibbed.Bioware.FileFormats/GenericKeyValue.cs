...
namespace Gibbed.Bioware.FileFormats
{
    ...
    {
        private static GenericKeyValue Invalid = new GenericKeyValue();

        public GenericFileFormat.FieldType Type;
        public uint StructureId;
        public bool Valid;
        public object Value;
        public Dictionary<int, GenericKeyValue> Values = null;
        ...
        public GenericKeyValue(GenericFileFormat.FieldType type, object value)
        {
            this.Type = type;
            this.Value = value;
            this.Valid = true;
        ...
        public GenericKeyValue this[int id]
        {
            get
            {
                if (this.Values == null)
            ...
            set
            {
                if (this.Values == null)
                {
                    if (value != null)
                    {
                        this.Values = new Dictionary<int, GenericKeyValue>();
