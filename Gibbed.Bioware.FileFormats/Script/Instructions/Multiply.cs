...
{
    [OpcodeHandler(Script.Opcode.MUL)]
    public class Multiply : IInstruction
    {
        ...
        public void Decode(byte[] code, ref int offset, OperandType operand, IState state)
        {
            if (operand != OperandType.IntegerInteger &&
                operand != OperandType.IntegerFloat &&
                operand != OperandType.FloatInteger &&
                operand != OperandType.FloatFloat &&
                operand != OperandType.VectorFloat &&
                operand != OperandType.FloatVector)
            {
